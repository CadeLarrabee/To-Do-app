...
class DomController {
  ...
  GenerateNavPanel(mainWrapper) {
    ...
    const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.format)(currentDate, "yyyy-MM-dd");
...
class Project {
  constructor(id, name, description, dueDate, priority, tasks) {
    ...
    this.dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.parse)(dueDate, "yyyy-MM-dd", new Date());
  ...
  set projectDue(newDate) {
    this.dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.parse)(newDate, "yyyy-MM-dd", new Date());
  }
