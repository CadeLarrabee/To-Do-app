...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,YAAY;EACZ,WAAW;AACb;AACA;EACE,WAAW;EACX,YAAY;AACd;AACA;EACE,YAAY;EACZ,aAAa;AACf;AACA;EACE,aAAa;EACb,aAAa;EACb,YAAY;AACd;AACA;EACE,aAAa;EACb,sBAAsB;EACtB,6BAA6B;EAC7B,QAAQ;AACV","sourcesContent":["* {\n  padding: 0px;\n  margin: 0px;\n}\nbutton {\n  width: 50px;\n  height: 50px;\n}\nform {\n  width: 400px;\n  height: 400px;\n}\n.mainWrapper {\n  display: flex;\n  height: 100vh;\n  width: 100vw;\n}\n.navWrapper {\n  display: flex;\n  flex-direction: column;\n  justify-content: space-around;\n  gap: 6px;\n}\n"],"sourceRoot":""}]);
// Exports
...
class DomController {
  ...
  GenerateNavPanel(mainWrapper, defaultProj) {
    ...
    const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(currentDate, "yyyy-MM-dd");
  ...
  AddNewProject(name, description, dueDate, priority) {
    ...
    const newProject = new _projectModule_js__WEBPACK_IMPORTED_MODULE_1__.Project(name, description, dueDate, priority);
